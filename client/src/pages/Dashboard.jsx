    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-white/50 mt-1">Here's your hotel reservation overview</p>
        </div>
        <div className="hidden sm:flex items-center gap-2 glass px-4 py-2 rounded-lg border border-green-500/20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {statCards.map(({ label, value, icon: Icon, color, bg }) => (
          <Card key={label} className={`border ${bg} hover:border-opacity-50 transition-all`}>
            <CardContent className="p-5">
              <div className="flex items-center justify-between">
                ...
                <div className={`w-12 h-12 rounded-xl ${bg} flex items-center justify-center border`}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Card className="border-white/8 hover:border-white/15 transition-all group">
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-white/40 text-sm">Find and book your perfect room</p>
              </div>
              <Link to="/rooms">
        ...
        <Card className="border-white/8 hover:border-white/15 transition-all">
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-white/40 text-sm">View and manage your bookings</p>
              </div>
        ...
        <div>
          ...
          <div className="space-y-3">
            {recentReservations.map((r) => (
              <Card key={r._id} className="border-white/8">
